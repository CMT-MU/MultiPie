...
_data_wyckoff_pg = {
    ...
    "C2h": [
        ...
        ("4c", "{[x,y,z],[-x,y,-z],[-x,-y,-z],[x,-y,z]}", "[1,1,1]", "1"),
    ],
    "D2": [
        ("1o", "{[0,0,0]}", "[0,0,0]", "222"),
        ...
        ("4d", "{[x,y,z],[-x,-y,z],[-x,y,-z],[x,-y,-z]}", "[1,1,1]", "1"),
    ],
    "C2v": [
        ("1a", "{[0,0,z]}", "[0,0,0]", "mm2"),
        ("2b", "{[x,0,z],[-x,0,z]}", "[1,0,0]", ".m."),
    ...
    "S4": [
        ...
        ("4b", "{[x,y,z],[-x,-y,z],[y,-x,-z],[-y,x,-z]}", "[1,0,1]", "1"),
    ],
    "C4h": [
        ("1o", "{[0,0,0]}", "[0,0,0]", "4/m"),
        ("2a", "{[0,0,z],[0,0,-z]}", "[0,0,1]", "4.."),
        ("4b", "{[x,y,0],[-x,-y,0],[-y,x,0],[y,-x,0]}", "[1,0,0]", "m.."),
        ("8c", "{[x,y,z],[-x,-y,z],[-y,x,z],[y,-x,z],[-x,-y,-z],[x,y,-z],[y,-x,-z],[-y,x,-z]}", "[1,0,1]", "1"),
    ],
    "D4": [
        ("1o", "{[0,0,0]}", "[0,0,0]", "422"),
        ("2a", "{[0,0,z],[0,0,-z]}", "[0,0,1]", "4.."),
        ...
        ("8d", "{[x,y,z],[-x,-y,z],[x,-y,-z],[-x,y,-z],[y,x,-z],[-y,-x,-z],[-y,x,z],[y,-x,z]}", "[2,1,1]", "1"),
    ],
    "C4v": [
        ("1a", "{[0,0,z]}", "[0,0,0]", "4mm"),
    ...
    "D2d-1": [
        ...
        ("4b", "{[x,x,0],[-x,-x,0],[-x,x,0],[x,-x,0]}", "[1,1,0]", "..2"),
        ("4c", "{[x,0,z],[-x,0,z],[0,x,-z],[0,-x,-z]}", "[1,0,0]", ".m."),
        ("8d", "{[x,y,z],[-x,-y,z],[y,x,-z],[-y,-x,-z],[-x,y,z],[x,-y,z],[y,-x,-z],[-y,x,-z]}", "[2,1,1]", "1"),
    ],
    "D4h": [
    ...
    "C3i": [
        ...
        ("6b", "{[x,y,z],[-y,x-y,z],[-x+y,-x,z],[-x,-y,-z],[y,-x+y,-z],[x-y,x,-z]}", "[-1,-1,1]", "1"),
    ],
    "D3": [
        ("1o", "{[0,0,0]}", "[0,0,0]", "312"),
        ("2a", "{[0,0,z],[0,0,-z]}", "[0,0,1]", "3.."),
