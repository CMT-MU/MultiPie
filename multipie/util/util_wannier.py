...
# ==================================================
def read_win(seedname, topdir=None):
    """
    Read ``seedname.win``.

    Args:
        seedname (str): Wannier90 seedname.
        topdir (str, optional): directory containing ``seedname.win``.
...
# ==================================================
def read_nnkp(seedname, topdir=None):
    """
    Read ``seedname.nnkp`` generated by Wannier90.

    Args:
        seedname (str): Wannier90 seedname.
        topdir (str, optional): directory containing ``seedname.nnkp``.
...
# ==================================================
def read_hr(hr_file, topdir=None):
    """
    Read ``seedname_hr.dat`` generated by Wannier90.

    Args:
        hr_file (str): Wannier90 Hamiltonian file.
        topdir (str, optional): directory containing ``seedname_hr.dat``.
...
def decompose_operator_by_SAMB(Or_dict, Zr_dict, digit=15):
    ...
    z = {
        zj: float(
            np.real(
                np.sum([_round(v) * Or_dict.get((-k[0], -k[1], -k[2], k[4], k[3]), (0, None))[0] for k, (v, b_no) in d.items()])
            )
        )
...
# ==================================================
def read_umat(seedname, topdir=None):
    """
...
# ==================================================
def read_eig(seedname, topdir=None):
    """
...
# ==================================================
def read_mmn(seedname, topdir=None):
    """
...
# ==================================================
def read_spn(seedname, topdir=None):
    """
...
# ==================================================
def read_uHu(seedname, topdir=None):
    """
...
# ==================================================
def read_uIu(seedname, topdir=None):
    """
