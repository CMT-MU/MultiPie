...
C3h = {
    ...
    "data": {
        ...
        "bond": {
            "bond_001": ("[1/3, 0, 0]@[1/6, 0, 0]", [0, 3], (1, 0), "[1/3, 0, 0]", "[0, 0, 0];[1/3, 0, 0]"),
            "bond_002": ("[0, 1/3, 0]@[0, 1/6, 0]", [1, 5], (2, 0), "[0, 1/3, 0]", "[0, 0, 0];[0, 1/3, 0]"),
            "bond_003": ("[-1/3, -1/3, 0]@[-1/6, -1/6, 0]", [2, 4], (3, 0), "[-1/3, -1/3, 0]", "[0, 0, 0];[-1/3, -1/3, 0]"),
            "bond_004": ("[1/6, 1/6, 0]@[5/12, 1/12, 0]", [0, 3], (4, 1), "[1/6, 1/6, 0]", "[1/3, 0, 0];[1/2, 1/6, 0]"),
            "bond_005": ("[-1/6, 0, 0]@[-1/12, 1/3, 0]", [1, 5], (5, 2), "[-1/6, 0, 0]", "[0, 1/3, 0];[-1/6, 1/3, 0]"),
            "bond_006": ("[0, -1/6, 0]@[-1/3, -5/12, 0]", [2, 4], (6, 3), "[0, -1/6, 0]", "[-1/3, -1/3, 0];[-1/3, -1/2, 0]"),
        },
        "cluster_atomic": {
            (0, 0): [(0, 0, "M_001")],
            ...
            (5, 5): [(28, 28, "M_001")],
            (6, 6): [(30, 30, "M_001")],
            (1, 0): [(2, 0, "M_001"), (4, 0, "M_004")],
            (2, 0): [(10, 0, "M_001"), (12, 0, "M_004")],
            (3, 0): [(18, 0, "M_001"), (20, 0, "M_004")],
            (4, 1): [(26, 2, "M_001"), (26, 4, "M_002")],
            (5, 2): [(28, 10, "M_001"), (28, 12, "M_002")],
            (6, 3): [(30, 18, "M_001"), (30, 20, "M_002")],
        },
        "atomic_braket": {
