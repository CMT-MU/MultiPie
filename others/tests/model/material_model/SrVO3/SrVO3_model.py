...
SrVO3 = {
    "info": {
        ...
        "crystal": "cubic",
        "cell": {"a": 3.8409, "b": 3.8409, "c": 3.8409, "alpha": 90.0, "beta": 90.0, "gamma": 90.0},
        "volume": 56.662926451929,
        "a1": "[3.8409, 0.0, 0.0]",
        "a2": "[0.0, 3.8409, 0.0]",
        "a3": "[0.0, 0.0, 3.8409]",
        ...
        "cell_bond": {
            ...
            "V:V:1:1_3": ("[0, 1, 0]@[0, 1/2, 0]", "[7,-10,15,16,-17,-18,-20,23,-31,34,-39,-40,41,42,44,-47]"),
            "V:V:2:1_1": ("[0, 1, 1]@[0, 1/2, 1/2]", "[1,-3,7,-10,-25,27,-31,34]"),
            "V:V:2:1_2": ("[0, 1, -1]@[0, 1/2, 1/2]", "[-2,4,-20,23,26,-28,44,-47]"),
            "V:V:2:1_3": ("[1, 0, -1]@[1/2, 0, 1/2]", "[5,-12,13,-19,-29,36,-37,43]"),
            "V:V:2:1_4": ("[1, -1, 0]@[1/2, 1/2, 0]", "[6,-16,18,-24,-30,40,-42,48]"),
            "V:V:2:1_5": ("[1, 0, 1]@[1/2, 0, 1/2]", "[-8,11,-14,22,32,-35,38,-46]"),
            "V:V:2:1_6": ("[1, 1, 0]@[1/2, 1/2, 0]", "[-9,15,-17,21,33,-39,41,-45]"),
        },
    },
    "name": {
        "alias": {"S_001": "V", "V": "S_001", "B_001": "V:V:1:1", "V:V:1:1": "B_001", "B_002": "V:V:2:1", "V:V:2:1": "B_002"},
        "site": {"site_001": ("V", 1)},
    ...
    "data": {
        ...
        "atomic_braket": {"M_001": (["dyz", "dzx", "dxy"], ["dyz", "dzx", "dxy"])},
    },
    "detail": {
        "rep_bond_all": {
            "V_V": [
