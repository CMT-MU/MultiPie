...
\end{center}
\begin{flushright}
Generated on 2023-06-12 23:05 by MultiPie 1.1.7
\end{flushright}
\vspace{1cm}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {13}} $\,\,\,\hat{\mathbb{Q}}_{4}^{(A_{1g})}$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {14}} $\,\,\,\hat{\mathbb{Q}}_{0}^{(A_{1g})}(1,-1)$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {15}} $\,\,\,\hat{\mathbb{Q}}_{4}^{(A_{1g})}(1,-1)$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
