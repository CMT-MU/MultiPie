...
\end{center}
\begin{flushright}
Generated on 2023-09-27 06:54 by MultiPie 1.1.14
\end{flushright}
\vspace{1cm}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {20}} $\,\,\,\hat{\mathbb{G}}_{3}^{(A_{g})}(1,1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{20}=\mathbb{X}_{14}[\mathbb{M}_{0}^{(a,A_{u})}(1,1)] \otimes\mathbb{U}_{27}[\mathbb{T}_{3}^{(u,A_{u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {21}} $\,\,\,\hat{\mathbb{G}}_{3}^{(A_{g})}(1,-1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {22}} $\,\,\,\hat{\mathbb{G}}_{3}^{(A_{g})}(1,-1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {23}} $\,\,\,\hat{\mathbb{Q}}_{4}^{(A_{g})}(1,-1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {25}} $\,\,\,\hat{\mathbb{Q}}_{0}^{(A_{g})}$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
