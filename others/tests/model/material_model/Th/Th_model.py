...
Th = {
    ...
    "data": {
        ...
        "bond": {
            "bond_001": ("[0, 0, -2]@[1, 1, 0]", [0, -13], (0, 5), "[0, 0, -2]", "[1, 1, 1];[1, 1, -1]"),
            "bond_002": ("[0, 0, -2]@[-1, -1, 0]", [1, -12], (1, 4), "bond_001", "[-1, -1, 1];[-1, -1, -1]"),
            "bond_003": ("[0, 0, 2]@[1, -1, 0]", [2, -15], (2, 7), "-bond_001", "[1, -1, -1];[1, -1, 1]"),
            "bond_004": ("[0, 0, 2]@[-1, 1, 0]", [3, -14], (3, 6), "-bond_001", "[-1, 1, -1];[-1, 1, 1]"),
            "bond_005": ("[-2, 0, 0]@[0, 1, 1]", [4, -18], (0, 6), "[-2, 0, 0]", "[1, 1, 1];[-1, 1, 1]"),
            "bond_006": ("[2, 0, 0]@[0, -1, 1]", [5, -19], (1, 7), "-bond_005", "[-1, -1, 1];[1, -1, 1]"),
            "bond_007": ("[-2, 0, 0]@[0, -1, -1]", [6, -16], (2, 4), "bond_005", "[1, -1, -1];[-1, -1, -1]"),
            "bond_008": ("[2, 0, 0]@[0, 1, -1]", [7, -17], (3, 5), "-bond_005", "[-1, 1, -1];[1, 1, -1]"),
            "bond_009": ("[0, -2, 0]@[1, 0, 1]", [8, -21], (0, 7), "[0, -2, 0]", "[1, 1, 1];[1, -1, 1]"),
            "bond_010": ("[0, -2, 0]@[-1, 0, -1]", [9, -20], (3, 4), "bond_009", "[-1, 1, -1];[-1, -1, -1]"),
            "bond_011": ("[0, 2, 0]@[-1, 0, 1]", [10, -23], (1, 6), "-bond_009", "[-1, -1, 1];[-1, 1, 1]"),
            "bond_012": ("[0, 2, 0]@[1, 0, -1]", [11, -22], (2, 5), "-bond_009", "[1, -1, -1];[1, 1, -1]"),
        },
        "cluster_atomic": {
            ...
            (0, 5): [(0, 40, "M_001"), (0, 42, "M_002"), (2, 40, "M_004"), (2, 42, "M_003")],
            (1, 4): [(8, 32, "M_001"), (8, 34, "M_002"), (10, 32, "M_004"), (10, 34, "M_003")],
            (2, 7): [(16, 56, "M_001"), (16, 58, "M_002"), (18, 56, "M_004"), (18, 58, "M_003")],
            (3, 6): [(24, 48, "M_001"), (24, 50, "M_002"), (26, 48, "M_004"), (26, 50, "M_003")],
            (0, 6): [(0, 48, "M_001"), (0, 50, "M_002"), (2, 48, "M_004"), (2, 50, "M_003")],
            (1, 7): [(8, 56, "M_001"), (8, 58, "M_002"), (10, 56, "M_004"), (10, 58, "M_003")],
            (2, 4): [(16, 32, "M_001"), (16, 34, "M_002"), (18, 32, "M_004"), (18, 34, "M_003")],
            (3, 5): [(24, 40, "M_001"), (24, 42, "M_002"), (26, 40, "M_004"), (26, 42, "M_003")],
            (0, 7): [(0, 56, "M_001"), (0, 58, "M_002"), (2, 56, "M_004"), (2, 58, "M_003")],
            (3, 4): [(24, 32, "M_001"), (24, 34, "M_002"), (26, 32, "M_004"), (26, 34, "M_003")],
            (1, 6): [(8, 48, "M_001"), (8, 50, "M_002"), (10, 48, "M_004"), (10, 50, "M_003")],
            (2, 5): [(16, 40, "M_001"), (16, 42, "M_002"), (18, 40, "M_004"), (18, 42, "M_003")],
        },
        "atomic_braket": {
