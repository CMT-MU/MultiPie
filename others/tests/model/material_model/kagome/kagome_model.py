    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {
                    "A:A:5:1": ("[1/2, 0, 1];[0, 1/2, 0]", "6g", "D", 5),
                    "A:A:5:2": ("[1/2, 0, 0];[0, 1/2, 1]", "6g", "D", 5),
                    "A:A:5:3": ("[-1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 5),
                    "A:A:5:4": ("[1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 5),
                },
                {
                    "A:A:6:1": ("[-1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6),
                    "A:A:6:2": ("[1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6),
                    "A:A:6:3": ("[1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6),
                    "A:A:6:4": ("[-1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6),
                    "A:A:6:5": ("[-1/2, 0, 1];[1/2, 0, 0]", "1b", "ND", 6),
                    "A:A:6:6": ("[-1/2, 0, 0];[1/2, 0, 1]", "1b", "ND", 6),
                },
                {"A:A:7:1": ("[-1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 7)},
                {
                    "A:A:8:1": ("[1/2, 0, 0];[1, 3/2, 1]", "6g", "D", 8),
                    "A:A:8:2": ("[-1/2, 0, 1];[1, 1/2, 0]", "6g", "D", 8),
                    "A:A:8:3": ("[1/2, 0, 1];[1, 3/2, 0]", "6g", "D", 8),
                    "A:A:8:4": ("[-1/2, 0, 0];[1, 1/2, 1]", "6g", "D", 8),
                },
                {
