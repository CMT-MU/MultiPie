    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {
                    "A:A:5:1": ("[1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:2": ("[-1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 5, "1"),
                ...
                },
                {
                    ...
                    "A:A:6:5": ("[-1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6, "-1"),
                    "A:A:6:6": ("[1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6, "-1"),
                },
                {"A:A:7:1": ("[-1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 7, "1")},
                {
                    ...
                    "A:A:8:4": ("[1/2, 0, 1];[1, 3/2, 0]", "6g", "D", 8, "1"),
                },
                {
