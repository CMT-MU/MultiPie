...
kagome = {
    ...
    "data": {
        ...
        "cluster_atomic": {
            ...
            (2, 0): [(16, 0, "M_001"), (16, 2, "M_002"), (18, 2, "M_003")],
        },
        "atomic_braket": {
    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {
                    "A:A:3:1": ("[1/2, 0, 0];[1/2, 0, 1]", "3f", "ND", 3, "-1"),
                    "A:A:3:2": ("[1/2, 0, 0];[1/2, 1, 0]", "3e", "ND", 3, "-1"),
                    "A:A:3:3": ("[-1/2, 0, 0];[1/2, 0, 0]", "1a", "ND", 3, "-3.."),
                    "A:A:3:4": ("[-1/2, 0, 0];[1/2, 1, 0]", "3e", "ND", 3, "-1"),
                },
                {
                    "A:A:4:1": ("[1/2, 0, 0];[1, 1/2, 1]", "6g", "D", 4, "1"),
                    "A:A:4:2": ("[1/2, 0, 1];[1, 1/2, 0]", "6g", "D", 4, "1"),
                },
                {
                    "A:A:5:1": ("[1/2, 0, 0];[0, 1/2, 1]", "6g", "D", 5, "1"),
                    "A:A:5:2": ("[1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:3": ("[-1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:4": ("[1/2, 0, 1];[0, 1/2, 0]", "6g", "D", 5, "1"),
                },
                {
                    "A:A:6:1": ("[1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6, "-1"),
                    "A:A:6:2": ("[-1/2, 0, 0];[1/2, 0, 1]", "1b", "ND", 6, "-3.."),
                    "A:A:6:3": ("[-1/2, 0, 1];[1/2, 0, 0]", "1b", "ND", 6, "-3.."),
                    "A:A:6:4": ("[1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6, "-1"),
                ...
                {"A:A:7:1": ("[-1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 7, "1")},
                {
                    ...
                    "A:A:8:2": ("[-1/2, 0, 0];[1, 1/2, 1]", "6g", "D", 8, "1"),
                    "A:A:8:3": ("[1/2, 0, 1];[1, 3/2, 0]", "6g", "D", 8, "1"),
                    "A:A:8:4": ("[-1/2, 0, 1];[1, 1/2, 0]", "6g", "D", 8, "1"),
                },
                {
                    "A:A:9:1": ("[-1/2, 1, 0];[1/2, 0, 0]", "3e", "ND", 9, "-1"),
                    "A:A:9:2": ("[-1/2, 0, 0];[3/2, 1, 0]", "3e", "ND", 9, "-1"),
