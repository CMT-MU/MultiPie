...
kagome = {
    "info": {
        ...
        "site": {"A": ("[1/2,0,0]", "s p")},
        "rep_site": {
            "A": ("[1/2, 0, 0]", "3e", [["(s,U)", "(s,D)"], ["(px,U)", "(px,D)", "(py,U)", "(py,D)", "(pz,U)", "(pz,D)"]], "-1")
        },
        "cell_site": {"A_1": ("[1/2, 0, 0]", "[1,4]"), "A_2": ("[0, 1/2, 0]", "[2,5]"), "A_3": ("[1/2, 1/2, 0]", "[3,6]")},
        "bond": [("A", "A", 1)],
        "rep_bond": {"A:A:1:1": ("[1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 1, "1")},
        "cell_bond": {
    ...
    "data": {
        ...
        "bond": {
            "bond_001": ("[1/2, 1/2, 0]@[3/4, 1/4, 0]", [0], (1, 0), "[1/2, 1/2, 0]", "[1/2, 0, 0];[1, 1/2, 0]"),
            "bond_002": ("[-1/2, 0, 0]@[3/4, 1/2, 0]", [1], (2, 1), "[-1/2, 0, 0]", "[1, 1/2, 0];[1/2, 1/2, 0]"),
            "bond_003": ("[0, 1/2, 0]@[1/2, 1/4, 0]", [-2], (2, 0), "[0, 1/2, 0]", "[1/2, 0, 0];[1/2, 1/2, 0]"),
            "bond_004": ("[-1/2, -1/2, 0]@[1/4, 3/4, 0]", [3], (1, 0), "-bond_001", "[1/2, 1, 0];[0, 1/2, 0]"),
            "bond_005": ("[1/2, 0, 0]@[1/4, 1/2, 0]", [4], (2, 1), "-bond_002", "[0, 1/2, 0];[1/2, 1/2, 0]"),
            "bond_006": ("[0, -1/2, 0]@[1/2, 3/4, 0]", [-5], (2, 0), "-bond_003", "[1/2, 1, 0];[1/2, 1/2, 0]"),
        },
        "cluster_atomic": {
            (0, 0): [(0, 0, "M_001"), (0, 2, "M_002"), (2, 2, "M_003")],
            (1, 1): [(8, 8, "M_001"), (8, 10, "M_002"), (10, 10, "M_003")],
            (2, 2): [(16, 16, "M_001"), (16, 18, "M_002"), (18, 18, "M_003")],
            (1, 0): [(8, 0, "M_001"), (8, 2, "M_002"), (10, 0, "M_004"), (10, 2, "M_003")],
            (2, 1): [(16, 8, "M_001"), (16, 10, "M_002"), (18, 8, "M_004"), (18, 10, "M_003")],
            (2, 0): [(16, 0, "M_001"), (16, 2, "M_002"), (18, 0, "M_004"), (18, 2, "M_003")],
        },
        "atomic_braket": {
    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                {},
                {"A:A:1:1": ("[1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 1, "1")},
                {"A:A:2:1": ("[1/2, 0, 0];[0, 1/2, 0]", "6g", "D", 2, "1")},
                {
                    "A:A:3:1": ("[-1/2, 0, 0];[1/2, 0, 0]", "1a", "ND", 3, "-3.."),
                    "A:A:3:2": ("[1/2, 0, 0];[1/2, 1, 0]", "3e", "ND", 3, "-1"),
                    "A:A:3:3": ("[-1/2, 0, 0];[1/2, 1, 0]", "3e", "ND", 3, "-1"),
                    "A:A:3:4": ("[1/2, 0, 0];[1/2, 0, 1]", "3f", "ND", 3, "-1"),
                },
                {
                    "A:A:4:1": ("[1/2, 0, 1];[1, 1/2, 0]", "6g", "D", 4, "1"),
                    "A:A:4:2": ("[1/2, 0, 0];[1, 1/2, 1]", "6g", "D", 4, "1"),
                },
                {
                    "A:A:5:1": ("[-1/2, 0, 0];[1, 1/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:2": ("[1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:3": ("[1/2, 0, 1];[0, 1/2, 0]", "6g", "D", 5, "1"),
                    "A:A:5:4": ("[1/2, 0, 0];[0, 1/2, 1]", "6g", "D", 5, "1"),
                },
                {
                    "A:A:6:1": ("[-1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6, "-1"),
                    "A:A:6:2": ("[1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6, "-1"),
                    "A:A:6:3": ("[-1/2, 0, 0];[1/2, 0, 1]", "1b", "ND", 6, "-3.."),
                    "A:A:6:4": ("[-1/2, 0, 1];[1/2, 0, 0]", "1b", "ND", 6, "-3.."),
                    "A:A:6:5": ("[-1/2, 0, 0];[1/2, 1, 1]", "3f", "ND", 6, "-1"),
                    "A:A:6:6": ("[1/2, 0, 1];[1/2, 1, 0]", "3f", "ND", 6, "-1"),
                },
                {"A:A:7:1": ("[-1/2, 0, 0];[1, 3/2, 0]", "6g", "D", 7, "1")},
                {
                    "A:A:8:1": ("[1/2, 0, 0];[1, 3/2, 1]", "6g", "D", 8, "1"),
                    "A:A:8:2": ("[1/2, 0, 1];[1, 3/2, 0]", "6g", "D", 8, "1"),
                    "A:A:8:3": ("[-1/2, 0, 1];[1, 1/2, 0]", "6g", "D", 8, "1"),
                    "A:A:8:4": ("[-1/2, 0, 0];[1, 1/2, 1]", "6g", "D", 8, "1"),
                },
                {
                    "A:A:9:1": ("[-1/2, 0, 0];[3/2, 1, 0]", "3e", "ND", 9, "-1"),
                    "A:A:9:2": ("[-1/2, 1, 0];[1/2, 0, 0]", "3e", "ND", 9, "-1"),
                    "A:A:9:3": ("[-1/2, -1, 0];[1/2, 1, 0]", "1a", "ND", 9, "-3.."),
                },
            ]
        },
