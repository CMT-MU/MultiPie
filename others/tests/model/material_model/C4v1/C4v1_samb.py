...
C4v1 = {
    "info": {
        ...
        "bond_cluster": {"B_001": ["bmp_002"], "B_002": ["bmp_003", "bmp_004", "bmp_005"]},
        "uniform": {"S_001": ["ump_001"]},
        "Z": {
            ("A1", "M_001", "S_001"): ["z_001"],
            ("A1", "M_001", "B_001"): ["z_002"],
            ("A1", "M_001", "B_002"): ["z_003", "z_004"],
        },
        "version": "1.1.7",
        "structure": {"B_001": ["kmp_001"], "B_002": ["kmp_002", "kmp_003", "kmp_004"]},
    ...
    "data": {
        ...
        "bond_cluster": {
            "bmp_002": ("Qb(0,A1,,)", "[1]"),
            "bmp_003": ("Qb(0,A1,,)", "[sqrt(2)/2, sqrt(2)/2]"),
            "bmp_004": ("Tb(1,E,,0)", "[0, I]"),
            "bmp_005": ("Tb(1,E,,1)", "[I, 0]"),
        },
        ...
        "Z": {
            ...
            "z_004": ("Q(1,A1,,|1,-1)", [("sqrt(2)/2", "amp_002", "bmp_005"), ("-sqrt(2)/2", "amp_003", "bmp_004")]),
        },
        "structure": {
            "kmp_001": ("Qk(0,A1,,)", "sqrt(2)*c001"),
            "kmp_002": ("Qk(0,A1,,)", "c002 + c003"),
            "kmp_003": ("Tk(1,E,,0)", "sqrt(2)*s003"),
            "kmp_004": ("Tk(1,E,,1)", "sqrt(2)*s002"),
        },
        "Zk": {
            "z_001": ("Q(0,A1,,)", [("1", "amp_001", "ump_001")]),
            "z_002": ("Q(0,A1,,)", [("1", "amp_001", "ump_001", "kmp_001")]),
            "z_003": ("Q(0,A1,,)", [("1", "amp_001", "ump_001", "kmp_002")]),
            "z_004": (
                "Q(1,A1,,|1,-1)",
                [("sqrt(2)/2", "amp_002", "ump_001", "kmp_004"), ("-sqrt(2)/2", "amp_003", "ump_001", "kmp_003")],
            ),
        },
    },
}
