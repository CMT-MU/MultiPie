...
B$_{6}$ & b$_{7}$ & A$_{1}$ & A$_{1}$ & 2 & 3 & $\begin{pmatrix} 0 & 1 & -1 \end{pmatrix}@\begin{pmatrix} 0 & \frac{1}{2} & \frac{1}{2} \end{pmatrix}$ & [1] \\
& b$_{8}$ & A$_{1}$ & A$_{1}$ & 2 & 3 & $\begin{pmatrix} 0 & -1 & -1 \end{pmatrix}@\begin{pmatrix} 0 & \frac{1}{2} & \frac{1}{2} \end{pmatrix}$ & [2] \\ \hline
B$_{7}$ & b$_{9}$ & A$_{1}$ & A$_{1}$ & 2 & 4 & $\begin{pmatrix} -1 & 0 & 1 \end{pmatrix}@\begin{pmatrix} \frac{1}{2} & 0 & \frac{1}{2} \end{pmatrix}$ & [1,2] \\
\end{longtable}
\end{center}
