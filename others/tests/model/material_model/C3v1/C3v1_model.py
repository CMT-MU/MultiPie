    ...
    "detail": {
        "rep_bond_all": {
            "A_B": [
                ...
                {
                    "A:B:3:1": ("[-2/3, -1/3, 0];[2/3, 1/3, 1]", "1a", "D", 3),
                    "A:B:3:2": ("[-2/3, -1/3, 1];[2/3, 1/3, 0]", "1a", "D", 3),
                    "A:B:3:3": ("[-2/3, -1/3, 0];[2/3, 4/3, 0]", "3d", "D", 3),
                },
                {
                    "A:B:4:1": ("[-2/3, -1/3, 1];[2/3, 4/3, 0]", "3d", "D", 4),
                    "A:B:4:2": ("[-2/3, -1/3, 0];[2/3, 4/3, 1]", "3d", "D", 4),
                },
                {
                ...
                {
                    "A:B:6:1": ("[-2/3, -4/3, 0];[2/3, 4/3, 0]", "1a", "D", 6),
                    "A:B:6:2": ("[-2/3, -1/3, 0];[5/3, 1/3, 1]", "3d", "D", 6),
                    "A:B:6:3": ("[-2/3, -1/3, 1];[5/3, 1/3, 0]", "3d", "D", 6),
                    "A:B:6:4": ("[-2/3, -1/3, 1];[2/3, 1/3, -1]", "1a", "D", 6),
                    "A:B:6:5": ("[-2/3, -1/3, -1];[2/3, 1/3, 1]", "1a", "D", 6),
                },
                {
                    "A:B:7:1": ("[-2/3, -4/3, 0];[5/3, 4/3, 0]", "3d", "D", 7),
                    "A:B:7:2": ("[-2/3, -1/3, -1];[2/3, 4/3, 1]", "3d", "D", 7),
                    "A:B:7:3": ("[-2/3, -1/3, 1];[2/3, 4/3, -1]", "3d", "D", 7),
                    "A:B:7:4": ("[-2/3, -4/3, 0];[2/3, 4/3, 1]", "1a", "D", 7),
                    "A:B:7:5": ("[-2/3, -4/3, 1];[2/3, 4/3, 0]", "1a", "D", 7),
                },
                {
                    "A:B:8:1": ("[-2/3, -4/3, 0];[5/3, 4/3, 1]", "3d", "D", 8),
                    "A:B:8:2": ("[-2/3, -4/3, 1];[5/3, 4/3, 0]", "3d", "D", 8),
                },
                {
