...
\end{center}
\begin{flushright}
Generated on 2023-05-24 22:44 by MultiPie 1.1.1
\end{flushright}
\vspace{1cm}
...
B$_{1}$ & b$_{1}$ & A$_{1}$ & B$_{1}$ & 1 & 1 & $\begin{pmatrix} \frac{1}{3} & \frac{2}{3} & 0 \end{pmatrix}@\begin{pmatrix} \frac{1}{2} & 0 & 0 \end{pmatrix}$ & [1,4] \\
& b$_{2}$ & A$_{1}$ & B$_{1}$ & 1 & 1 & $\begin{pmatrix} - \frac{2}{3} & - \frac{1}{3} & 0 \end{pmatrix}@\begin{pmatrix} 0 & \frac{1}{2} & 0 \end{pmatrix}$ & [2,6] \\
& b$_{3}$ & A$_{1}$ & B$_{1}$ & 1 & 1 & $\begin{pmatrix} \frac{1}{3} & - \frac{1}{3} & 0 \end{pmatrix}@\begin{pmatrix} \frac{1}{2} & \frac{1}{2} & 0 \end{pmatrix}$ & [3,5] \\
\end{longtable}
\end{center}
