...
C3v = {
    ...
    "data": {
        ...
        "bond": {
            "bond_001": ("[1/3, 1/6, 0]@[0, -1/12, 0]", [0, -4], (0, 1), "[1/3, 1/6, 0]", "[-1/6, -1/6, 0];[1/6, 0, 0]"),
            "bond_002": ("[-1/6, 1/6, 0]@[1/12, 1/12, 0]", [1, -3], (1, 2), "[-1/6, 1/6, 0]", "[1/6, 0, 0];[0, 1/6, 0]"),
            "bond_003": ("[1/6, 1/3, 0]@[-1/12, 0, 0]", [-2, 5], (0, 2), "[1/6, 1/3, 0]", "[-1/6, -1/6, 0];[0, 1/6, 0]"),
            "bond_004": ("[-1/2, 1/6, 0]@[-5/12, -1/12, 0]", [0], (0, 3), "[-1/2, 1/6, 0]", "[-1/6, -1/6, 0];[-2/3, 0, 0]"),
            "bond_005": ("[-1/6, -2/3, 0]@[1/12, -1/3, 0]", [1], (1, 4), "[-1/6, -2/3, 0]", "[1/6, 0, 0];[0, -2/3, 0]"),
            "bond_006": ("[2/3, 1/2, 0]@[1/3, 5/12, 0]", [2], (2, 5), "[2/3, 1/2, 0]", "[0, 1/6, 0];[2/3, 2/3, 0]"),
            "bond_007": ("[-2/3, -1/6, 0]@[-1/3, 1/12, 0]", [3], (2, 3), "[-2/3, -1/6, 0]", "[0, 1/6, 0];[-2/3, 0, 0]"),
            "bond_008": ("[1/2, 2/3, 0]@[5/12, 1/3, 0]", [4], (1, 5), "[1/2, 2/3, 0]", "[1/6, 0, 0];[2/3, 2/3, 0]"),
            "bond_009": ("[1/6, -1/2, 0]@[-1/12, -5/12, 0]", [5], (0, 4), "[1/6, -1/2, 0]", "[-1/6, -1/6, 0];[0, -2/3, 0]"),
        },
        "cluster_atomic": {
            (0, 0): [(0, 0, "M_001")],
            (1, 1): [(1, 1, "M_001")],
