...
\end{center}
\begin{flushright}
Generated on 2023-05-24 22:39 by MultiPie 1.1.1
\end{flushright}
\vspace{1cm}
...
S$_{1}$ & A$_1$ & $\begin{pmatrix} - \frac{1}{6} & - \frac{1}{6} & 0 \end{pmatrix}$ & [1,6] \\
& A$_2$ & $\begin{pmatrix} \frac{1}{6} & 0 & 0 \end{pmatrix}$ & [2,5] \\
& A$_3$ & $\begin{pmatrix} 0 & \frac{1}{6} & 0 \end{pmatrix}$ & [3,4] \\ \hline
S$_{2}$ & B$_1$ & $\begin{pmatrix} - \frac{2}{3} & 0 & 0 \end{pmatrix}$ & [1,4] \\
