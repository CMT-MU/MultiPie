...
D3 = {
    "info": {
        ...
        "site": {"A": ("[1,0,1]", "s p")},
        "rep_site": {
            "A": ("[1, 0, 1]", "6c", [["(s,U)", "(s,D)"], ["(px,U)", "(px,D)", "(py,U)", "(py,D)", "(pz,U)", "(pz,D)"]])
        },
        "cell_site": {
            "A_1": ("[1, 0, 1]", "[1]"),
            "A_2": ("[1, 0, -1]", "[2]"),
        ...
        "bond": [("A", "A", [1, 2])],
        "rep_bond": {"A:A:1:1": ("[1, 0, 1];[0, 1, 1]", "6c", "D", 1), "A:A:2:1": ("[1, 0, 1];[1, 0, -1]", "3b", "ND", 2)},
        "cell_bond": {
    ...
    "data": {
        ...
        "bond": {
            "bond_001": ("[-1, 1, 0]@[1/2, 1/2, 1]", [0], (0, 4), "[-1, 1, 0]", "[1, 0, 1];[0, 1, 1]"),
            "bond_002": ("[-2, -1, 0]@[0, -1/2, -1]", [1], (1, 2), "[-2, -1, 0]", "[1, 0, -1];[-1, -1, -1]"),
            "bond_003": ("[1, 2, 0]@[-1/2, 0, -1]", [2], (2, 3), "[1, 2, 0]", "[-1, -1, -1];[0, 1, -1]"),
            "bond_004": ("[-1, 1, 0]@[1/2, 1/2, -1]", [-3], (1, 3), "bond_001", "[1, 0, -1];[0, 1, -1]"),
            "bond_005": ("[-1, -2, 0]@[-1/2, 0, 1]", [4], (4, 5), "-bond_003", "[0, 1, 1];[-1, -1, 1]"),
            "bond_006": ("[-2, -1, 0]@[0, -1/2, 1]", [-5], (0, 5), "bond_002", "[1, 0, 1];[-1, -1, 1]"),
            "bond_007": ("[0, 0, -2]@[1, 0, 0]", [0, -1], (0, 1), "[0, 0, -2]", "[1, 0, 1];[1, 0, -1]"),
            "bond_008": ("[0, 0, 2]@[-1, -1, 0]", [2, -5], (2, 5), "-bond_007", "[-1, -1, -1];[-1, -1, 1]"),
            "bond_009": ("[0, 0, 2]@[0, 1, 0]", [3, -4], (3, 4), "-bond_007", "[0, 1, -1];[0, 1, 1]"),
        },
        "cluster_atomic": {
            ...
            (0, 4): [(0, 32, "M_001"), (0, 34, "M_002"), (2, 32, "M_004"), (2, 34, "M_003")],
            (1, 2): [(8, 16, "M_001"), (8, 18, "M_002"), (10, 16, "M_004"), (10, 18, "M_003")],
            (2, 3): [(16, 24, "M_001"), (16, 26, "M_002"), (18, 24, "M_004"), (18, 26, "M_003")],
            (1, 3): [(8, 24, "M_001"), (8, 26, "M_002"), (10, 24, "M_004"), (10, 26, "M_003")],
            (4, 5): [(32, 40, "M_001"), (32, 42, "M_002"), (34, 40, "M_004"), (34, 42, "M_003")],
    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                {},
                {"A:A:1:1": ("[1, 0, 1];[0, 1, 1]", "6c", "D", 1)},
                {"A:A:2:1": ("[1, 0, 1];[1, 0, -1]", "3b", "ND", 2)},
                {"A:A:3:1": ("[1, 0, 1];[-1, -1, -1]", "3b", "ND", 3), "A:A:3:2": ("[1, 0, 1];[0, 1, -1]", "3b", "ND", 3)},
            ]
        },
        "max_neighbor": 10,
        "version": "1.1.2",
