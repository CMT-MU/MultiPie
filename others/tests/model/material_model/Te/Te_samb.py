...
Te = {
    "info": {
        "atomic": {"M_001": ["amp_001", "amp_002", "amp_003", "amp_004", "amp_005", "amp_006", "amp_007", "amp_008", "amp_009"]},
        "site_cluster": {"S_001": ["smp_001", "smp_002", "smp_003"]},
        "bond_cluster": {"B_001": ["bmp_004", "bmp_005", "bmp_006", "bmp_007", "bmp_008", "bmp_009"]},
        "Z": {
            ("A1", "M_001", "S_001"): ["z_001", "z_002", "z_003", "z_004"],
            ("A1", "M_001", "B_001"): ["z_005", "z_006", "z_007", "z_008", "z_009", "z_010"],
        },
        "version": "1.1.14",
        "harmonics": {
            "Q": [
    ...
    "data": {
        "atomic": {
            ...
            "amp_007": ("Ma(1,A2,,)", (3, 3), [(0, 1, "-sqrt(2)*I/2"), (1, 0, "sqrt(2)*I/2")]),
            "amp_008": ("Ma(1,E,,0)", (3, 3), [(0, 2, "-sqrt(2)*I/2"), (2, 0, "sqrt(2)*I/2")]),
            "amp_009": ("Ma(1,E,,1)", (3, 3), [(1, 2, "-sqrt(2)*I/2"), (2, 1, "sqrt(2)*I/2")]),
        },
        "site_cluster": {
        ...
        "bond_cluster": {
            ...
            "bmp_007": ("Tb(1,A2,,)", "[sqrt(3)*I/3, -sqrt(3)*I/3, sqrt(3)*I/3]"),
            "bmp_008": ("Tb(1,E,,0)", "[sqrt(2)*I/2, sqrt(2)*I/2, 0]"),
            "bmp_009": ("Tb(1,E,,1)", "[sqrt(6)*I/6, -sqrt(6)*I/6, -sqrt(6)*I/3]"),
        },
        "Z": {
            ...
            "z_009": (
                "G(0,A1,,)",
                [("sqrt(3)/3", "amp_007", "bmp_007"), ("-sqrt(3)/3", "amp_008", "bmp_009"), ("sqrt(3)/3", "amp_009", "bmp_008")],
            ),
            "z_010": (
                "G(2,A1,,)",
                [("sqrt(6)/3", "amp_007", "bmp_007"), ("sqrt(6)/6", "amp_008", "bmp_009"), ("-sqrt(6)/6", "amp_009", "bmp_008")],
            ),
        },
    },
}
