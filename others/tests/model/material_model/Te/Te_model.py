...
Te = {
    "info": {
        ...
        "rep_site": {"A": ("[137/500, 0, 1/3]", "3a", [["px", "py", "pz"]], ".2.")},
        "cell_site": {
        ...
        "bond": [("A", "A", [1])],
        "rep_bond": {"A:A:1:1": ("[137/500, 1, 1/3];[-137/500, 363/500, 0]", "3b", "ND", 1, ".2.")},
        "cell_bond": {
    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {
                    "A:A:3:1": ("[137/500, 0, 1/3];[637/500, 0, 1/3]", "3a", "D", 3, ".2."),
                ...
                {"A:A:6:1": ("[137/500, 0, 1/3];[-137/500, 363/500, 0]", "3b", "D", 6, ".2.")},
                {"A:A:7:1": ("[137/500, 0, 1/3];[137/500, 0, 4/3]", "3b", "ND", 7, ".2.")},
                {"A:A:8:1": ("[-363/500, 0, 1/3];[363/500, 363/500, 0]", "3b", "ND", 8, ".2.")},
