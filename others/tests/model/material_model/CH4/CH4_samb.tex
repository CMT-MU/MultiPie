...
& b$_{4}$ & H$_{4}$ & C$_{1}$ & 1 & 1 & $\begin{pmatrix} - \frac{1}{3} & \frac{1}{3} & - \frac{1}{3} \end{pmatrix}@\begin{pmatrix} - \frac{1}{6} & \frac{1}{6} & - \frac{1}{6} \end{pmatrix}$ & [4,8,10,14,20,22] \\
\end{longtable}
\end{center}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {10}} $\,\,\,\hat{\mathbb{G}}_{0}^{(A_{2})}(1,1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{10}=\mathbb{X}_{11}[\mathbb{G}_{0}^{(a,A_{2})}(1,1)] \otimes\mathbb{U}_{3}[\mathbb{Q}_{0}^{(u,A_{1})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {11}} $\,\,\,\hat{\mathbb{G}}_{3}^{(A_{2})}(1,-1)$ [M$_{2}$,\,B$_{1}$]
\begin{dmath*}
