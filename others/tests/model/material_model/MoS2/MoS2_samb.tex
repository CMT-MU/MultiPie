...
\end{center}
\begin{flushright}
Generated on 2023-06-12 23:03 by MultiPie 1.1.7
\end{flushright}
\vspace{1cm}
...
B$_{2}$ & b$_{4}$ & S$_{1}$ & Mo$_{1}$ & 1 & 1 & $\begin{pmatrix} \frac{2}{3} & \frac{1}{3} & 0.12425 \end{pmatrix}@\begin{pmatrix} \frac{1}{3} & \frac{1}{6} & 0.062125 \end{pmatrix}$ & [1,8] \\
