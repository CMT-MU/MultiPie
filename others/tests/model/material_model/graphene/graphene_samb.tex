...
\end{center}
\begin{flushright}
Generated on 2023-06-01 17:47 by MultiPie 1.1.2
\end{flushright}
\vspace{1cm}
...
& b$_{3}$ & A$_{1}$ & A$_{2}$ & 1 & 1 & $\begin{pmatrix} - \frac{2}{3} & - \frac{1}{3} & 0 \end{pmatrix}@\begin{pmatrix} 0 & \frac{1}{2} & 0 \end{pmatrix}$ & [-5,8,9,-12,16,-20,-21,24] \\ \hline
