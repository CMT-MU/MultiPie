...
\end{center}
\begin{flushright}
Generated on 2023-06-18 17:05 by MultiPie 1.1.10
\end{flushright}
\vspace{1cm}
...
B$_{2}$ [6l: mm2] & b$_{4}$ & A$_{1}$ & A$_{1}$ & 2 & 1 & $\begin{pmatrix} 0 & 1 & 0 \end{pmatrix}@\begin{pmatrix} \frac{1}{3} & \frac{1}{6} & 0 \end{pmatrix}$ & [1,-7,-15,17] \\
