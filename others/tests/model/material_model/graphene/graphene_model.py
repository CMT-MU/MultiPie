...
graphene = {
    ...
    "data": {
        ...
        "cluster_atomic": {(0, 0): [(0, 0, "M_001")], (1, 1): [(1, 1, "M_001")], (0, 1): [(0, 1, "M_001")]},
    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {"A:A:4:1": ("[-2/3, -1/3, 0];[2/3, 4/3, 0]", "3f", "ND", 4)},
                {"A:A:5:1": ("[-2/3, -1/3, 0];[4/3, 2/3, 0]", "6l", "D", 5)},
                {"A:A:6:1": ("[-2/3, -1/3, 0];[4/3, 5/3, 0]", "2c", "ND", 6)},
                {"A:A:7:1": ("[-2/3, -1/3, 0];[5/3, 1/3, 0]", "3f", "ND", 7)},
                {"A:A:8:1": ("[-2/3, -4/3, 0];[2/3, 4/3, 0]", "1a", "ND", 8)},
                {"A:A:9:1": ("[-2/3, -4/3, 0];[5/3, 4/3, 0]", "3f", "ND", 9)},
            ]
        },
