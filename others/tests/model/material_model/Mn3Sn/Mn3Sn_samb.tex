...
$ 13 $ & $ \mathbb{Q}_{4,0}^{(E_{2g},2)} $ & $ 4 $ & $ E_{2g} $ & $ 2 $ & $ 0 $ & $ - \frac{\sqrt{5} \left(x - y\right) \left(x + y\right) \left(x^{2} + y^{2} - 6 z^{2}\right)}{4} $ \\
$ 14 $ & $ \mathbb{Q}_{4,1}^{(E_{2g},2)} $ & $ 4 $ & $ E_{2g} $ & $ 2 $ & $ 1 $ & $ \frac{\sqrt{5} x y \left(x^{2} + y^{2} - 6 z^{2}\right)}{2} $ \\ \hline
$ 15 $ & $ \mathbb{Q}_{6}^{(A_{2g})} $ & $ 6 $ & $ A_{2g} $ & $ - $ & $ - $ & $ \frac{\sqrt{462} x y \left(x^{2} - 3 y^{2}\right) \left(3 x^{2} - y^{2}\right)}{16} $ \\
\end{longtable}
\end{center}
\begin{center}
\renewcommand{\arraystretch}{1.3}
