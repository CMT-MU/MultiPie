...
MoS2 = {
    ...
    #
    "site": {"Mo": ("[0,0,0]", ["du", "dv", "dxy", "dyz", "dxz"]), "S": ("[2/3, 1/3, 0.12425]", ["px", "py", "pz"])},
...
SrVO3 = {
    ...
    #
    "site": {"V": ("[0.0, 0.0, 0.0]", ["dyz", "dxz", "dxy"])},
    "bond": [("V", "V", [1, 2])],
    #
    "spinful": False,
}
...
URu2Si2 = {
    ...
    "group": 139,
    "cell": {"a": 4.126, "c": 9.58},
    "site": {"U": ("[0,0,0]", ["(7/2,f)", "(5/2,f)", "(5/2,d)", "(3/2,d)"])},
    "bond": [("U", "U", 1)],
}


conventional_models = [BCT, GaAs, C3v5, URu2Si2]
