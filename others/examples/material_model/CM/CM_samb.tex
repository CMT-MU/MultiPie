...
\end{center}
\begin{flushright}
Generated on 2023-06-01 17:26 by MultiPie 1.1.2
\end{flushright}
\vspace{1cm}
...
B$_{2}$ & b$_{5}$ & H$_{1}$ & H$_{2}$ & 1 & 1 & $\begin{pmatrix} - \frac{2}{3} & - \frac{2}{3} & 0 \end{pmatrix}@\begin{pmatrix} 0 & 0 & \frac{1}{3} \end{pmatrix}$ & [1,-2,-13,16] \\
...
& b$_{8}$ & H$_{2}$ & H$_{4}$ & 1 & 1 & $\begin{pmatrix} 0 & \frac{2}{3} & - \frac{2}{3} \end{pmatrix}@\begin{pmatrix} - \frac{1}{3} & 0 & 0 \end{pmatrix}$ & [6,-8,-14,21] \\
& b$_{9}$ & H$_{1}$ & H$_{4}$ & 1 & 1 & $\begin{pmatrix} - \frac{2}{3} & 0 & - \frac{2}{3} \end{pmatrix}@\begin{pmatrix} 0 & \frac{1}{3} & 0 \end{pmatrix}$ & [9,-10,18,-20] \\
& b$_{10}$ & H$_{2}$ & H$_{3}$ & 1 & 1 & $\begin{pmatrix} \frac{2}{3} & 0 & - \frac{2}{3} \end{pmatrix}@\begin{pmatrix} 0 & - \frac{1}{3} & 0 \end{pmatrix}$ & [11,-12,-15,23] \\
\end{longtable}
\end{center}
...
\begin{dmath*}
\hat{\mathbb{Z}}_{2}=\mathbb{X}_{2}[\mathbb{Q}_{0}^{(a,A_{1})}] \otimes\mathbb{U}_{1}[\mathbb{Q}_{0}^{(s,A_{1})}]
\end{dmath*}
\vspace{4mm}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {5}} $\,\,\,\hat{\mathbb{Q}}_{0}^{(A_{1})}$ [M$_{4}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{5}=\frac{\sqrt{3} \mathbb{X}_{3}[\mathbb{Q}_{1,0}^{(a,T_{2})}] \otimes\mathbb{U}_{4}[\mathbb{Q}_{1,0}^{(u,T_{2})}]}{3} + \frac{\sqrt{3} \mathbb{X}_{4}[\mathbb{Q}_{1,1}^{(a,T_{2})}] \otimes\mathbb{U}_{5}[\mathbb{Q}_{1,1}^{(u,T_{2})}]}{3} + \frac{\sqrt{3} \mathbb{X}_{5}[\mathbb{Q}_{1,2}^{(a,T_{2})}] \otimes\mathbb{U}_{6}[\mathbb{Q}_{1,2}^{(u,T_{2})}]}{3}
\end{dmath*}
\vspace{4mm}
...
$ \mathbb{X}_{2} $ & $\mathbb{Q}_{0}^{(a,A_{1})}$ & M$_{3}$ & $\begin{pmatrix} \frac{\sqrt{3}}{3} & 0 & 0 \\ 0 & \frac{\sqrt{3}}{3} & 0 \\ 0 & 0 & \frac{\sqrt{3}}{3} \end{pmatrix}$ \\ \hline
$ \mathbb{X}_{3} $ & $\mathbb{Q}_{1,0}^{(a,T_{2})}$ & M$_{4}$ & $\begin{pmatrix} 1 \\ 0 \\ 0 \end{pmatrix}$ \\
$ \mathbb{X}_{4} $ & $\mathbb{Q}_{1,1}^{(a,T_{2})}$ & M$_{4}$ & $\begin{pmatrix} 0 \\ 1 \\ 0 \end{pmatrix}$ \\
$ \mathbb{X}_{5} $ & $\mathbb{Q}_{1,2}^{(a,T_{2})}$ & M$_{4}$ & $\begin{pmatrix} 0 \\ 0 \\ 1 \end{pmatrix}$ \\
\end{longtable}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% uniform SAMB.
