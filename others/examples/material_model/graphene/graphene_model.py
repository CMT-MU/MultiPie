    ...
    "detail": {
        "rep_bond_all": {
            "A_A": [
                ...
                {
                    "A:A:5:1": ("[-2/3, -1/3, 0];[2/3, 1/3, 1]", "1b", "ND", 5, "6/mmm"),
                    "A:A:5:2": ("[-2/3, -1/3, 0];[2/3, 4/3, 0]", "3f", "ND", 5, "mmm"),
                },
