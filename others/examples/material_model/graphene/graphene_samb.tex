...
\end{center}
\begin{flushright}
Generated on 2023-09-27 17:44 by MultiPie 1.1.15
\end{flushright}
\vspace{1cm}
...
\quad - irrep: \texttt{[A1g, A2g, B1g, B2g, E1g, E2g, A1u, A2u, B1u, B2u, E1u, E2u]}
...
\begin{dmath*}
\hat{\mathbb{Z}}_{2}=\mathbb{X}_{1}[\mathbb{Q}_{0}^{(a,A_{1g})}] \otimes\mathbb{Y}_{3}[\mathbb{Q}_{0}^{(b,A_{1g})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {3}} $\,\,\,\hat{\mathbb{Q}}_{2,0}^{(E_{2g})}$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{3}=\mathbb{X}_{1}[\mathbb{Q}_{0}^{(a,A_{1g})}] \otimes\mathbb{Y}_{4}[\mathbb{Q}_{2,0}^{(b,E_{2g})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {4}} $\,\,\,\hat{\mathbb{Q}}_{2,1}^{(E_{2g})}$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{4}=\mathbb{X}_{1}[\mathbb{Q}_{0}^{(a,A_{1g})}] \otimes\mathbb{Y}_{5}[\mathbb{Q}_{2,1}^{(b,E_{2g})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {5}} $\,\,\,\hat{\mathbb{G}}_{0}^{(A_{1u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{5}=- \frac{\sqrt{2} \mathbb{X}_{3}[\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{7}[\mathbb{T}_{1,1}^{(b,E_{1u})}]}{2} + \frac{\sqrt{2} \mathbb{X}_{4}[\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{6}[\mathbb{T}_{1,0}^{(b,E_{1u})}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {6}} $\,\,\,\hat{\mathbb{Q}}_{1}^{(A_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{6}=\frac{\sqrt{2} \mathbb{X}_{3}[\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{6}[\mathbb{T}_{1,0}^{(b,E_{1u})}]}{2} + \frac{\sqrt{2} \mathbb{X}_{4}[\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{7}[\mathbb{T}_{1,1}^{(b,E_{1u})}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {7}} $\,\,\,\hat{\mathbb{Q}}_{3}^{(B_{1u})}$ [M$_{1}$,\,S$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{7}=\mathbb{X}_{1}[\mathbb{Q}_{0}^{(a,A_{1g})}] \otimes\mathbb{Y}_{2}[\mathbb{Q}_{3}^{(s,B_{1u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {8}} $\,\,\,\hat{\mathbb{Q}}_{3}^{(B_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{8}=- \mathbb{X}_{2}[\mathbb{M}_{1}^{(a,A_{2g})}(1,1)] \otimes\mathbb{Y}_{8}[\mathbb{T}_{3}^{(b,B_{1u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {9}} $\,\,\,\hat{\mathbb{Q}}_{1,0}^{(E_{1u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{9}=- \mathbb{X}_{2}[\mathbb{M}_{1}^{(a,A_{2g})}(1,1)] \otimes\mathbb{Y}_{7}[\mathbb{T}_{1,1}^{(b,E_{1u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {10}} $\,\,\,\hat{\mathbb{Q}}_{1,1}^{(E_{1u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{10}=\mathbb{X}_{2}[\mathbb{M}_{1}^{(a,A_{2g})}(1,1)] \otimes\mathbb{Y}_{6}[\mathbb{T}_{1,0}^{(b,E_{1u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {11}} $\,\,\,\hat{\mathbb{G}}_{2,0}^{(E_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{11}=- \frac{\sqrt{2} \mathbb{X}_{3}[\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{6}[\mathbb{T}_{1,0}^{(b,E_{1u})}]}{2} + \frac{\sqrt{2} \mathbb{X}_{4}[\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{7}[\mathbb{T}_{1,1}^{(b,E_{1u})}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {12}} $\,\,\,\hat{\mathbb{G}}_{2,1}^{(E_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{12}=\frac{\sqrt{2} \mathbb{X}_{3}[\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{7}[\mathbb{T}_{1,1}^{(b,E_{1u})}]}{2} + \frac{\sqrt{2} \mathbb{X}_{4}[\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{6}[\mathbb{T}_{1,0}^{(b,E_{1u})}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {13}} $\,\,\,\hat{\mathbb{G}}_{2,0}^{(E_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{13}=\mathbb{X}_{4}[\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{8}[\mathbb{T}_{3}^{(b,B_{1u})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {14}} $\,\,\,\hat{\mathbb{G}}_{2,1}^{(E_{2u})}(1,1)$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{14}=- \mathbb{X}_{3}[\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)] \otimes\mathbb{Y}_{8}[\mathbb{T}_{3}^{(b,B_{1u})}]
\end{dmath*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% atomic SAMB group.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
$ \mathbb{X}_{2} $ & $\mathbb{M}_{1}^{(a,A_{2g})}(1,1)$ & M$_{1}$ & $\begin{pmatrix} \frac{\sqrt{2}}{2} & 0 \\ 0 & - \frac{\sqrt{2}}{2} \end{pmatrix}$ \\
$ \mathbb{X}_{3} $ & $\mathbb{M}_{1,0}^{(a,E_{1g})}(1,1)$ & M$_{1}$ & $\begin{pmatrix} 0 & - \frac{\sqrt{2} i}{2} \\ \frac{\sqrt{2} i}{2} & 0 \end{pmatrix}$ \\
$ \mathbb{X}_{4} $ & $\mathbb{M}_{1,1}^{(a,E_{1g})}(1,1)$ & M$_{1}$ & $\begin{pmatrix} 0 & - \frac{\sqrt{2}}{2} \\ - \frac{\sqrt{2}}{2} & 0 \end{pmatrix}$ \\
\end{longtable}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% cluster SAMB.
...
$ \mathbb{Y}_{1} $ & $\mathbb{Q}_{0}^{(s,A_{1g})}$ & S$_{1}$ & $\begin{pmatrix} \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} \end{pmatrix}$ \\
$ \mathbb{Y}_{2} $ & $\mathbb{Q}_{3}^{(s,B_{1u})}$ & S$_{1}$ & $\begin{pmatrix} \frac{\sqrt{2}}{2} & - \frac{\sqrt{2}}{2} \end{pmatrix}$ \\ \hline
$ \mathbb{Y}_{3} $ & $\mathbb{Q}_{0}^{(b,A_{1g})}$ & B$_{1}$ & $\begin{pmatrix} \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} & \frac{\sqrt{3}}{3} \end{pmatrix}$ \\
$ \mathbb{Y}_{4} $ & $\mathbb{Q}_{2,0}^{(b,E_{2g})}$ & B$_{1}$ & $\begin{pmatrix} \frac{\sqrt{6}}{3} & - \frac{\sqrt{6}}{6} & - \frac{\sqrt{6}}{6} \end{pmatrix}$ \\
$ \mathbb{Y}_{5} $ & $\mathbb{Q}_{2,1}^{(b,E_{2g})}$ & B$_{1}$ & $\begin{pmatrix} 0 & - \frac{\sqrt{2}}{2} & \frac{\sqrt{2}}{2} \end{pmatrix}$ \\
$ \mathbb{Y}_{6} $ & $\mathbb{T}_{1,0}^{(b,E_{1u})}$ & B$_{1}$ & $\begin{pmatrix} 0 & \frac{\sqrt{2} i}{2} & - \frac{\sqrt{2} i}{2} \end{pmatrix}$ \\
$ \mathbb{Y}_{7} $ & $\mathbb{T}_{1,1}^{(b,E_{1u})}$ & B$_{1}$ & $\begin{pmatrix} \frac{\sqrt{6} i}{3} & - \frac{\sqrt{6} i}{6} & - \frac{\sqrt{6} i}{6} \end{pmatrix}$ \\
$ \mathbb{Y}_{8} $ & $\mathbb{T}_{3}^{(b,B_{1u})}$ & B$_{1}$ & $\begin{pmatrix} \frac{\sqrt{3} i}{3} & \frac{\sqrt{3} i}{3} & \frac{\sqrt{3} i}{3} \end{pmatrix}$ \\
\end{longtable}
\end{center}
...
$ 2 $ & $ \mathbb{Q}_{1,0}^{(E_{1u})} $ & $ 1 $ & $ E_{1u} $ & $ - $ & $ 0 $ & $ x $ \\
$ 3 $ & $ \mathbb{Q}_{1,1}^{(E_{1u})} $ & $ 1 $ & $ E_{1u} $ & $ - $ & $ 1 $ & $ y $ \\ \hline
$ 4 $ & $ \mathbb{Q}_{2,0}^{(E_{2g})} $ & $ 2 $ & $ E_{2g} $ & $ - $ & $ 0 $ & $ \frac{\sqrt{3} \left(x - y\right) \left(x + y\right)}{2} $ \\
$ 5 $ & $ \mathbb{Q}_{2,1}^{(E_{2g})} $ & $ 2 $ & $ E_{2g} $ & $ - $ & $ 1 $ & $ - \sqrt{3} x y $ \\ \hline
$ 6 $ & $ \mathbb{Q}_{3}^{(B_{1u})} $ & $ 3 $ & $ B_{1u} $ & $ - $ & $ - $ & $ \frac{\sqrt{10} y \left(3 x^{2} - y^{2}\right)}{4} $ \\
\end{longtable}
\end{center}
\begin{center}
\renewcommand{\arraystretch}{1.3}
...
$ 1 $ & $ \mathbb{G}_{1}^{(A_{2g})} $ & $ 1 $ & $ A_{2g} $ & $ - $ & $ - $ & $ Z $ \\
$ 2 $ & $ \mathbb{G}_{1,0}^{(E_{1g})} $ & $ 1 $ & $ E_{1g} $ & $ - $ & $ 0 $ & $ - Y $ \\
$ 3 $ & $ \mathbb{G}_{1,1}^{(E_{1g})} $ & $ 1 $ & $ E_{1g} $ & $ - $ & $ 1 $ & $ X $ \\
\end{longtable}
\end{center}
