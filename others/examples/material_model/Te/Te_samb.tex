...
S$_{1}$ [3a: .2.] & A$_1$ & $\begin{pmatrix} 0.274 & 0 & \frac{1}{3} \end{pmatrix}$ & [1,2] \\
...
B$_{1}$ [3b: .2.] & b$_{1}$ & A$_{2}$ & A$_{1}$ & 1 & 1 & $\begin{pmatrix} -0.548 & -0.274 & - \frac{1}{3} \end{pmatrix}@\begin{pmatrix} 0 & 0.863 & \frac{1}{6} \end{pmatrix}$ & [1,-3] \\
...
$ 5 $ & $ \mathbb{Q}_{2,0}^{(E,1)} $ & $ 2 $ & $ E $ & $ 1 $ & $ 0 $ & $ \sqrt{3} y z $ \\
$ 6 $ & $ \mathbb{Q}_{2,1}^{(E,1)} $ & $ 2 $ & $ E $ & $ 1 $ & $ 1 $ & $ - \sqrt{3} x z $ \\
$ 7 $ & $ \mathbb{Q}_{2,0}^{(E,2)} $ & $ 2 $ & $ E $ & $ 2 $ & $ 0 $ & $ \frac{\sqrt{3} \left(x - y\right) \left(x + y\right)}{2} $ \\
$ 8 $ & $ \mathbb{Q}_{2,1}^{(E,2)} $ & $ 2 $ & $ E $ & $ 2 $ & $ 1 $ & $ - \sqrt{3} x y $ \\
\end{longtable}
\end{center}
