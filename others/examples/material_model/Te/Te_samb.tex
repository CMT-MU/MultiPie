...
\end{center}
\begin{flushright}
Generated on 2023-05-24 22:37 by MultiPie 1.1.1
\end{flushright}
\vspace{1cm}
...
B$_{1}$ & b$_{1}$ & A$_{1}$ & A$_{2}$ & 1 & 1 & $\begin{pmatrix} -0.548 & -0.274 & - \frac{1}{3} \end{pmatrix}@\begin{pmatrix} 0 & 0.863 & \frac{1}{6} \end{pmatrix}$ & [1,-3] \\
& b$_{2}$ & A$_{1}$ & A$_{3}$ & 1 & 1 & $\begin{pmatrix} -0.274 & 0.274 & \frac{1}{3} \end{pmatrix}@\begin{pmatrix} 0.137 & 0.137 & \frac{1}{2} \end{pmatrix}$ & [2,-5] \\
& b$_{3}$ & A$_{2}$ & A$_{3}$ & 1 & 1 & $\begin{pmatrix} 0.274 & 0.548 & - \frac{1}{3} \end{pmatrix}@\begin{pmatrix} 0.863 & 0 & \frac{5}{6} \end{pmatrix}$ & [-4,6] \\
\end{longtable}
\end{center}
...
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {9}} $\,\,\,\hat{\mathbb{G}}_{0}^{(A_{1})}$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
