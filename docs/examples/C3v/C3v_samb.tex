...
\end{center}
\begin{flushright}
Generated on 2024-08-08 23:12 by MultiPie 1.2.18
\end{flushright}
\vspace{1cm}
...
B$_{1}$ [3b: ..m] & b$_{1}$ & A$_{1}$ & A$_{2}$ & 1 & 1 & $\begin{pmatrix} \frac{1}{3} & \frac{1}{6} & 0 \end{pmatrix}@\begin{pmatrix} 0 & - \frac{1}{12} & 0 \end{pmatrix}$ & [1,-5] \\
...
B$_{2}$ [6c: 1] & b$_{4}$ & A$_{1}$ & B$_{1}$ & 1 & 1 & $\begin{pmatrix} - \frac{1}{2} & \frac{1}{6} & 0 \end{pmatrix}@\begin{pmatrix} - \frac{5}{12} & - \frac{1}{12} & 0 \end{pmatrix}$ & [1] \\
...
& b$_{8}$ & A$_{2}$ & B$_{3}$ & 1 & 1 & $\begin{pmatrix} \frac{1}{2} & \frac{2}{3} & 0 \end{pmatrix}@\begin{pmatrix} \frac{5}{12} & \frac{1}{3} & 0 \end{pmatrix}$ & [5] \\
& b$_{9}$ & A$_{1}$ & B$_{2}$ & 1 & 1 & $\begin{pmatrix} \frac{1}{6} & - \frac{1}{2} & 0 \end{pmatrix}@\begin{pmatrix} - \frac{1}{12} & - \frac{5}{12} & 0 \end{pmatrix}$ & [6] \\
\end{longtable}
\end{center}
...
\begin{dmath*}
\hat{\mathbb{Z}}_{2}=\mathbb{X}_{002}[\mathbb{Q}_{0}^{(a,A_{1})}] \otimes\mathbb{U}_{002}[\mathbb{Q}_{0}^{(s,A_{1})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {3}} $\,\,\,\hat{\mathbb{Q}}_{2}^{(A_{1})}$ [M$_{2}$,\,S$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{3}=\mathbb{X}_{003}[\mathbb{Q}_{2}^{(a,A_{1})}] \otimes\mathbb{U}_{002}[\mathbb{Q}_{0}^{(s,A_{1})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {4}} $\,\,\,\hat{\mathbb{Q}}_{1}^{(A_{1})}$ [M$_{2}$,\,S$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{4}=\frac{\sqrt{2} \mathbb{X}_{004}[\mathbb{Q}_{2,0}^{(a,E,1)}] \otimes\mathbb{U}_{003}[\mathbb{Q}_{1,0}^{(s,E)}]}{2} + \frac{\sqrt{2} \mathbb{X}_{005}[\mathbb{Q}_{2,1}^{(a,E,1)}] \otimes\mathbb{U}_{004}[\mathbb{Q}_{1,1}^{(s,E)}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {5}} $\,\,\,\hat{\mathbb{Q}}_{3}^{(A_{1},2)}$ [M$_{2}$,\,S$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{5}=\frac{\sqrt{2} \mathbb{X}_{006}[\mathbb{Q}_{2,0}^{(a,E,2)}] \otimes\mathbb{U}_{003}[\mathbb{Q}_{1,0}^{(s,E)}]}{2} + \frac{\sqrt{2} \mathbb{X}_{007}[\mathbb{Q}_{2,1}^{(a,E,2)}] \otimes\mathbb{U}_{004}[\mathbb{Q}_{1,1}^{(s,E)}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {6}} $\,\,\,\hat{\mathbb{Q}}_{0}^{(A_{1})}$ [M$_{1}$,\,B$_{1}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{6}=\mathbb{X}_{001}[\mathbb{Q}_{0}^{(a,A_{1})}] \otimes\mathbb{U}_{005}[\mathbb{Q}_{0}^{(u,A_{1})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {7}} $\,\,\,\hat{\mathbb{Q}}_{1}^{(A_{1})}$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{7}=\mathbb{X}_{008}[\mathbb{Q}_{1}^{(a,A_{1})}] \otimes\mathbb{U}_{006}[\mathbb{Q}_{0}^{(u,A_{1})}]
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {8}} $\,\,\,\hat{\mathbb{Q}}_{0}^{(A_{1})}$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{8}=\frac{\sqrt{2} \mathbb{X}_{009}[\mathbb{Q}_{1,0}^{(a,E)}] \otimes\mathbb{U}_{007}[\mathbb{Q}_{1,0}^{(u,E)}]}{2} + \frac{\sqrt{2} \mathbb{X}_{010}[\mathbb{Q}_{1,1}^{(a,E)}] \otimes\mathbb{U}_{008}[\mathbb{Q}_{1,1}^{(u,E)}]}{2}
\end{dmath*}
\vspace{4mm}
\noindent \fbox{No. {9}} $\,\,\,\hat{\mathbb{Q}}_{3}^{(A_{1},2)}$ [M$_{3}$,\,B$_{2}$]
\begin{dmath*}
\hat{\mathbb{Z}}_{9}=\frac{\sqrt{2} \mathbb{X}_{009}[\mathbb{Q}_{1,0}^{(a,E)}] \otimes\mathbb{U}_{009}[\mathbb{Q}_{2,0}^{(u,E,2)}]}{2} + \frac{\sqrt{2} \mathbb{X}_{010}[\mathbb{Q}_{1,1}^{(a,E)}] \otimes\mathbb{U}_{010}[\mathbb{Q}_{2,1}^{(u,E,2)}]}{2}
\end{dmath*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% atomic SAMB group.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
