...
- SAMB.
  ...
  - **combined_cluster** (dict): combined cluster info, dict[combined SAMB ID, site/bond_name].
  ...
  - **cluster_vector** (dict): cluster vector info, dict[site/bond_name, [primitive_vector]].
