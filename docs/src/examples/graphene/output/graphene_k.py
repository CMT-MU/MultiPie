...
graphene_k = {
    ...
    "k_matrix": {
        ...
        "z2": {(0, -1, 0, 1, 0): "sqrt(6)*exp(I*kb_1)/6", (1, 0, 0, 1, 0): "sqrt(6)*exp(I*kb_2)/6", (0, 0, 0, 1, 0): "sqrt(6)*exp(I*kb_3)/6", (0, 1, 0, 0, 1): "sqrt(6)*exp(-I*kb_1)/6", (-1, 0, 0, 0, 1): "sqrt(6)*exp(-I*kb_2)/6", (0, 0, 0, 0, 1): "sqrt(6)*exp(-I*kb_3)/6"},
        "z3": {
            (-1, 0, 0, 0, 0): "sqrt(3)*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "sqrt(3)*exp(I*kb_2)/6",
            (1, 1, 0, 0, 0): "sqrt(3)*exp(I*kb_3)/6",
            (1, 0, 0, 1, 1): "sqrt(3)*exp(I*kb_4)/6",
            (0, 1, 0, 1, 1): "sqrt(3)*exp(I*kb_5)/6",
            (-1, -1, 0, 1, 1): "sqrt(3)*exp(I*kb_6)/6",
            (1, 0, 0, 0, 0): "sqrt(3)*exp(-I*kb_1)/6",
            (0, 1, 0, 0, 0): "sqrt(3)*exp(-I*kb_2)/6",
            (-1, -1, 0, 0, 0): "sqrt(3)*exp(-I*kb_3)/6",
            (-1, 0, 0, 1, 1): "sqrt(3)*exp(-I*kb_4)/6",
        ...
        "z4": {
            (-1, 0, 0, 0, 0): "sqrt(3)*I*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "sqrt(3)*I*exp(I*kb_2)/6",
            (1, 1, 0, 0, 0): "sqrt(3)*I*exp(I*kb_3)/6",
            (1, 0, 0, 1, 1): "sqrt(3)*I*exp(I*kb_4)/6",
            (0, 1, 0, 1, 1): "sqrt(3)*I*exp(I*kb_5)/6",
            (-1, -1, 0, 1, 1): "sqrt(3)*I*exp(I*kb_6)/6",
            (1, 0, 0, 0, 0): "-sqrt(3)*I*exp(-I*kb_1)/6",
            (0, 1, 0, 0, 0): "-sqrt(3)*I*exp(-I*kb_2)/6",
            (-1, -1, 0, 0, 0): "-sqrt(3)*I*exp(-I*kb_3)/6",
            (-1, 0, 0, 1, 1): "-sqrt(3)*I*exp(-I*kb_4)/6",
        ...
        "z6": {(0, -1, 0, 1, 0): "sqrt(6)*I*exp(I*kb_1)/6", (1, 0, 0, 1, 0): "sqrt(6)*I*exp(I*kb_2)/6", (0, 0, 0, 1, 0): "sqrt(6)*I*exp(I*kb_3)/6", (0, 1, 0, 0, 1): "-sqrt(6)*I*exp(-I*kb_1)/6", (-1, 0, 0, 0, 1): "-sqrt(6)*I*exp(-I*kb_2)/6", (0, 0, 0, 0, 1): "-sqrt(6)*I*exp(-I*kb_3)/6"},
        "z7": {
            (-1, 0, 0, 0, 0): "sqrt(3)*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "sqrt(3)*exp(I*kb_2)/6",
            (1, 1, 0, 0, 0): "sqrt(3)*exp(I*kb_3)/6",
        ...
        "z9": {(1, 0, 0, 1, 0): "-I*exp(I*kb_2)/2", (0, 0, 0, 1, 0): "I*exp(I*kb_3)/2", (-1, 0, 0, 0, 1): "I*exp(-I*kb_2)/2", (0, 0, 0, 0, 1): "-I*exp(-I*kb_3)/2"},
        "z10": {(0, -1, 0, 1, 0): "sqrt(3)*I*exp(I*kb_1)/3", (1, 0, 0, 1, 0): "-sqrt(3)*I*exp(I*kb_2)/6", (0, 0, 0, 1, 0): "-sqrt(3)*I*exp(I*kb_3)/6", (0, 1, 0, 0, 1): "-sqrt(3)*I*exp(-I*kb_1)/3", (-1, 0, 0, 0, 1): "sqrt(3)*I*exp(-I*kb_2)/6", (0, 0, 0, 0, 1): "sqrt(3)*I*exp(-I*kb_3)/6"},
        "z11": {
            (0, -1, 0, 0, 0): "-sqrt(2)*exp(I*kb_2)/4",
            (1, 1, 0, 0, 0): "sqrt(2)*exp(I*kb_3)/4",
            (0, 1, 0, 1, 1): "sqrt(2)*exp(I*kb_5)/4",
            (-1, -1, 0, 1, 1): "-sqrt(2)*exp(I*kb_6)/4",
            (0, 1, 0, 0, 0): "-sqrt(2)*exp(-I*kb_2)/4",
            (-1, -1, 0, 0, 0): "sqrt(2)*exp(-I*kb_3)/4",
            (0, -1, 0, 1, 1): "sqrt(2)*exp(-I*kb_5)/4",
            (1, 1, 0, 1, 1): "-sqrt(2)*exp(-I*kb_6)/4",
        ...
        "z12": {
            (-1, 0, 0, 0, 0): "sqrt(6)*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "-sqrt(6)*exp(I*kb_2)/12",
            (1, 1, 0, 0, 0): "-sqrt(6)*exp(I*kb_3)/12",
            (1, 0, 0, 1, 1): "-sqrt(6)*exp(I*kb_4)/6",
            (0, 1, 0, 1, 1): "sqrt(6)*exp(I*kb_5)/12",
            (-1, -1, 0, 1, 1): "sqrt(6)*exp(I*kb_6)/12",
            (1, 0, 0, 0, 0): "sqrt(6)*exp(-I*kb_1)/6",
            (0, 1, 0, 0, 0): "-sqrt(6)*exp(-I*kb_2)/12",
            (-1, -1, 0, 0, 0): "-sqrt(6)*exp(-I*kb_3)/12",
            (-1, 0, 0, 1, 1): "-sqrt(6)*exp(-I*kb_4)/6",
        ...
        "z13": {
            (-1, 0, 0, 0, 0): "sqrt(6)*I*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "-sqrt(6)*I*exp(I*kb_2)/12",
            (1, 1, 0, 0, 0): "-sqrt(6)*I*exp(I*kb_3)/12",
            (1, 0, 0, 1, 1): "-sqrt(6)*I*exp(I*kb_4)/6",
            (0, 1, 0, 1, 1): "sqrt(6)*I*exp(I*kb_5)/12",
            (-1, -1, 0, 1, 1): "sqrt(6)*I*exp(I*kb_6)/12",
            (1, 0, 0, 0, 0): "-sqrt(6)*I*exp(-I*kb_1)/6",
            (0, 1, 0, 0, 0): "sqrt(6)*I*exp(-I*kb_2)/12",
            (-1, -1, 0, 0, 0): "sqrt(6)*I*exp(-I*kb_3)/12",
            (-1, 0, 0, 1, 1): "sqrt(6)*I*exp(-I*kb_4)/6",
        ...
        "z14": {
            (0, -1, 0, 0, 0): "sqrt(2)*I*exp(I*kb_2)/4",
            (1, 1, 0, 0, 0): "-sqrt(2)*I*exp(I*kb_3)/4",
            (0, 1, 0, 1, 1): "-sqrt(2)*I*exp(I*kb_5)/4",
            (-1, -1, 0, 1, 1): "sqrt(2)*I*exp(I*kb_6)/4",
            (0, 1, 0, 0, 0): "-sqrt(2)*I*exp(-I*kb_2)/4",
            (-1, -1, 0, 0, 0): "sqrt(2)*I*exp(-I*kb_3)/4",
            (0, -1, 0, 1, 1): "sqrt(2)*I*exp(-I*kb_5)/4",
            (1, 1, 0, 1, 1): "-sqrt(2)*I*exp(-I*kb_6)/4",
        },
        "z15": {(0, -1, 0, 1, 0): "sqrt(3)*exp(I*kb_1)/3", (1, 0, 0, 1, 0): "-sqrt(3)*exp(I*kb_2)/6", (0, 0, 0, 1, 0): "-sqrt(3)*exp(I*kb_3)/6", (0, 1, 0, 0, 1): "sqrt(3)*exp(-I*kb_1)/3", (-1, 0, 0, 0, 1): "-sqrt(3)*exp(-I*kb_2)/6", (0, 0, 0, 0, 1): "-sqrt(3)*exp(-I*kb_3)/6"},
        "z16": {(1, 0, 0, 1, 0): "exp(I*kb_2)/2", (0, 0, 0, 1, 0): "-exp(I*kb_3)/2", (-1, 0, 0, 0, 1): "exp(-I*kb_2)/2", (0, 0, 0, 0, 1): "-exp(-I*kb_3)/2"},
        "z17": {
            (-1, 0, 0, 0, 0): "sqrt(6)*exp(I*kb_1)/6",
            (0, -1, 0, 0, 0): "-sqrt(6)*exp(I*kb_2)/12",
            (1, 1, 0, 0, 0): "-sqrt(6)*exp(I*kb_3)/12",
