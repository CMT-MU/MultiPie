...
graphene_k = {
    "model": "graphene",
    "source": "graphene.pkl",
    "created": "2026-08-07 20:31:51",
    "dimension": 2,
    "ket": ["pz@C(1)", "pz@C(2)"],
    "index": {("C", 1, 1): (0, 1), ("C", 2, 1): (1, 1)},
    "cluster_vector": {
        "C": {},
        "C;C_001_1": {"p_1": "0.33333333*k_1+0.66666666*k_2", "p_2": "-0.66666666*k_1-0.33333333*k_2", "p_3": "0.33333333*k_1-0.33333333*k_2"},
        "C;C_002_1": {"p_1": "1.0*k_1", "p_2": "1.0*k_2", "p_3": "-1.0*k_1-1.0*k_2", "p_4": "-1.0*k_1", "p_5": "-1.0*k_2", "p_6": "1.0*k_1+1.0*k_2"},
    },
    "k_multipole": {
    ...
    "k_matrix": {
        ...
        "z2": ("C;C_001_1", "3a@3f", {(1, 0): "sqrt(6)*(I*sin(p_1)+I*sin(p_2)+I*sin(p_3)+cos(p_1)+cos(p_2)+cos(p_3))/6", (0, 1): "sqrt(6)*(-I*sin(p_1)-I*sin(p_2)-I*sin(p_3)+cos(p_1)+cos(p_2)+cos(p_3))/6"}),
        "z3": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(3)*(cos(p_1)+cos(p_2)+cos(p_3))/3", (1, 1): "sqrt(3)*(cos(p_4)+cos(p_5)+cos(p_6))/3"}),
        "z4": ("C;C_002_1", "6b@6l", {(0, 0): "-sqrt(3)*(sin(p_1)+sin(p_2)+sin(p_3))/3", (1, 1): "-sqrt(3)*(sin(p_4)+sin(p_5)+sin(p_6))/3"}),
        "z5": ("C", "2c", {(0, 0): "sqrt(2)/2", (1, 1): "-sqrt(2)/2"}),
        "z6": ("C;C_001_1", "3a@3f", {(1, 0): "sqrt(6)*(-sin(p_1)-sin(p_2)-sin(p_3)+I*cos(p_1)+I*cos(p_2)+I*cos(p_3))/6", (0, 1): "-sqrt(6)*(sin(p_1)+sin(p_2)+sin(p_3)+I*cos(p_1)+I*cos(p_2)+I*cos(p_3))/6"}),
        "z7": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(3)*(cos(p_1)+cos(p_2)+cos(p_3))/3", (1, 1): "-sqrt(3)*(cos(p_4)+cos(p_5)+cos(p_6))/3"}),
        "z8": ("C;C_002_1", "6b@6l", {(0, 0): "-sqrt(3)*(sin(p_1)+sin(p_2)+sin(p_3))/3", (1, 1): "sqrt(3)*(sin(p_4)+sin(p_5)+sin(p_6))/3"}),
        "z9": ("C;C_001_1", "3a@3f", {(1, 0): "(sin(p_2)-sin(p_3)-I*cos(p_2)+I*cos(p_3))/2", (0, 1): "(sin(p_2)-sin(p_3)+I*cos(p_2)-I*cos(p_3))/2"}),
        "z10": ("C;C_001_1", "3a@3f", {(1, 0): "sqrt(3)*(-2*sin(p_1)+sin(p_2)+sin(p_3)+2*I*cos(p_1)-I*cos(p_2)-I*cos(p_3))/6", (0, 1): "sqrt(3)*(-2*sin(p_1)+sin(p_2)+sin(p_3)-2*I*cos(p_1)+I*cos(p_2)+I*cos(p_3))/6"}),
        "z11": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(2)*(-cos(p_2)+cos(p_3))/2", (1, 1): "sqrt(2)*(cos(p_5)-cos(p_6))/2"}),
        "z12": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(6)*(2*cos(p_1)-cos(p_2)-cos(p_3))/6", (1, 1): "sqrt(6)*(-2*cos(p_4)+cos(p_5)+cos(p_6))/6"}),
        "z13": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(6)*(-2*sin(p_1)+sin(p_2)+sin(p_3))/6", (1, 1): "sqrt(6)*(2*sin(p_4)-sin(p_5)-sin(p_6))/6"}),
        "z14": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(2)*(-sin(p_2)+sin(p_3))/2", (1, 1): "sqrt(2)*(sin(p_5)-sin(p_6))/2"}),
        "z15": ("C;C_001_1", "3a@3f", {(1, 0): "sqrt(3)*(2*I*sin(p_1)-I*sin(p_2)-I*sin(p_3)+2*cos(p_1)-cos(p_2)-cos(p_3))/6", (0, 1): "sqrt(3)*(-2*I*sin(p_1)+I*sin(p_2)+I*sin(p_3)+2*cos(p_1)-cos(p_2)-cos(p_3))/6"}),
        "z16": ("C;C_001_1", "3a@3f", {(1, 0): "(I*sin(p_2)-I*sin(p_3)+cos(p_2)-cos(p_3))/2", (0, 1): "(-I*sin(p_2)+I*sin(p_3)+cos(p_2)-cos(p_3))/2"}),
        "z17": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(6)*(2*cos(p_1)-cos(p_2)-cos(p_3))/6", (1, 1): "sqrt(6)*(2*cos(p_4)-cos(p_5)-cos(p_6))/6"}),
        "z18": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(2)*(cos(p_2)-cos(p_3))/2", (1, 1): "sqrt(2)*(cos(p_5)-cos(p_6))/2"}),
        "z19": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(2)*(-sin(p_2)+sin(p_3))/2", (1, 1): "sqrt(2)*(-sin(p_5)+sin(p_6))/2"}),
        "z20": ("C;C_002_1", "6b@6l", {(0, 0): "sqrt(6)*(2*sin(p_1)-sin(p_2)-sin(p_3))/6", (1, 1): "sqrt(6)*(2*sin(p_4)-sin(p_5)-sin(p_6))/6"}),
    },
}
