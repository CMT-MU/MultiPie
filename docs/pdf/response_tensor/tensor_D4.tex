...
\begin{center}
\LARGE
Response Tensors up to 4th rank in $D_{4}$
\end{center}
...
\end{quote}
\begin{align*}
S^{(4,G)} = \begin{pmatrix} S^{(4,G)}_{11} & S^{(4,G)}_{12} & S^{(4,G)}_{13} & 0 & 0 & 0 \\ S^{(4,G)}_{12} & S^{(4,G)}_{11} & S^{(4,G)}_{13} & 0 & 0 & 0 \\ S^{(4,G)}_{13} & S^{(4,G)}_{13} & S^{(4,G)}_{33} & 0 & 0 & 0 \\ 0 & 0 & 0 & S^{(4,G)}_{44} & 0 & 0 \\ 0 & 0 & 0 & 0 & S^{(4,G)}_{44} & 0 \\ 0 & 0 & 0 & 0 & 0 & S^{(4,G)}_{66} \end{pmatrix}
\end{align*}
\begin{quote}
\begin{align*}
