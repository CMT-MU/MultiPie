...
$ 19 $ & $ \frac{\sqrt{5} \left(x^{4} - 6 x^{2} z^{2} - y^{4} + 6 y^{2} z^{2}\right)}{4} $ \\
...
\begin{tabular}{cl} \hline \hline
No. & expression \\ \hline
$ 26 $ & $ \frac{3 \sqrt{35} x y z \left(x^{2} - y^{2}\right)}{2} $ \\
...
$ 40 $ & $ \frac{\sqrt{42} \left(x^{6} - 10 x^{4} y^{2} - 5 x^{4} z^{2} + 10 x^{2} y^{4} + 5 x^{2} z^{4} - y^{6} + 5 y^{4} z^{2} - 5 y^{2} z^{4}\right)}{8} $ \\
...
$ 51 $ & $ \frac{\sqrt{231} x y z \left(- 3 x^{4} + 10 x^{2} z^{2} + 3 y^{4} - 10 y^{2} z^{2}\right)}{4} $ \\
...
$ 67 $ & $ \frac{\sqrt{858} \left(- x^{8} + 14 x^{6} y^{2} + 14 x^{6} z^{2} - 210 x^{4} y^{2} z^{2} - 14 x^{2} y^{6} + 210 x^{2} y^{4} z^{2} + y^{8} - 14 y^{6} z^{2}\right)}{64} $ \\
...
$ 69 $ & $ \frac{3 \sqrt{70} \left(- x^{8} - 2 x^{6} y^{2} + 30 x^{6} z^{2} + 30 x^{4} y^{2} z^{2} - 80 x^{4} z^{4} + 2 x^{2} y^{6} - 30 x^{2} y^{4} z^{2} + 32 x^{2} z^{6} + y^{8} - 30 y^{6} z^{2} + 80 y^{4} z^{4} - 32 y^{2} z^{6}\right)}{64} $ \\
...
$ 84 $ & $ \frac{\sqrt{4290} x y z \left(3 x^{6} - 14 x^{4} y^{2} - 7 x^{4} z^{2} + 14 x^{2} y^{4} + 7 x^{2} z^{4} - 3 y^{6} + 7 y^{4} z^{2} - 7 y^{2} z^{4}\right)}{8} $ \\
...
$ 103 $ & $ \frac{\sqrt{420189} \left(- 22 x^{10} - 45 x^{8} y^{2} + 1035 x^{8} z^{2} + 105 x^{6} y^{4} + 630 x^{6} y^{2} z^{2} - 4935 x^{6} z^{4} + 105 x^{4} y^{6} - 3150 x^{4} y^{4} z^{2} + 1575 x^{4} y^{2} z^{4} + 4830 x^{4} z^{6} - 45 x^{2} y^{8} + 630 x^{2} y^{6} z^{2} + 1575 x^{2} y^{4} z^{4} - 1260 x^{2} y^{2} z^{6} - 990 x^{2} z^{8} - 22 y^{10} + 1035 y^{8} z^{2} - 4935 y^{6} z^{4} + 4830 y^{4} z^{6} - 990 y^{2} z^{8} + 44 z^{10}\right)}{35952} $ \\
$ 104 $ & $ \frac{\sqrt{140063} \cdot \left(22 x^{10} - 675 x^{8} y^{2} - 315 x^{8} z^{2} + 3255 x^{6} y^{4} - 630 x^{6} y^{2} z^{2} + 1575 x^{6} z^{4} - 3255 x^{4} y^{6} + 1575 x^{4} y^{2} z^{4} - 1680 x^{4} z^{6} + 675 x^{2} y^{8} + 630 x^{2} y^{6} z^{2} - 1575 x^{2} y^{4} z^{4} + 360 x^{2} z^{8} - 22 y^{10} + 315 y^{8} z^{2} - 1575 y^{6} z^{4} + 1680 y^{4} z^{6} - 360 y^{2} z^{8}\right)}{11984} $ \\
$ 105 $ & $ \frac{\sqrt{3213210} \left(- 3 x^{10} + 96 x^{8} y^{2} + 39 x^{8} z^{2} - 224 x^{6} y^{4} - 1344 x^{6} y^{2} z^{2} + 42 x^{6} z^{4} - 224 x^{4} y^{6} + 6720 x^{4} y^{4} z^{2} - 3360 x^{4} y^{2} z^{4} + 182 x^{4} z^{6} + 96 x^{2} y^{8} - 1344 x^{2} y^{6} z^{2} - 3360 x^{2} y^{4} z^{4} + 2688 x^{2} y^{2} z^{6} - 135 x^{2} z^{8} - 3 y^{10} + 39 y^{8} z^{2} + 42 y^{6} z^{4} + 182 y^{4} z^{6} - 135 y^{2} z^{8} + 6 z^{10}\right)}{23968} $ \\
$ 106 $ & $ \frac{\sqrt{1071070} \cdot \left(9 x^{10} - 174 x^{8} y^{2} - 231 x^{8} z^{2} + 140 x^{6} y^{4} + 4032 x^{6} y^{2} z^{2} + 406 x^{6} z^{4} - 140 x^{4} y^{6} - 10080 x^{4} y^{2} z^{4} + 266 x^{4} z^{6} + 174 x^{2} y^{8} - 4032 x^{2} y^{6} z^{2} + 10080 x^{2} y^{4} z^{4} - 57 x^{2} z^{8} - 9 y^{10} + 231 y^{8} z^{2} - 406 y^{6} z^{4} - 266 y^{4} z^{6} + 57 y^{2} z^{8}\right)}{23968} $ \\
...
$ 123 $ & $ \frac{\sqrt{692835} x y z \left(- x^{8} + 6 x^{6} y^{2} + 6 x^{6} z^{2} - 42 x^{4} y^{2} z^{2} - 6 x^{2} y^{6} + 42 x^{2} y^{4} z^{2} + y^{8} - 6 y^{6} z^{2}\right)}{32} $ \\
...
$ 125 $ & $ \frac{3 \sqrt{1001} x y z \left(- 5 x^{8} - 10 x^{6} y^{2} + 70 x^{6} z^{2} + 70 x^{4} y^{2} z^{2} - 168 x^{4} z^{4} + 10 x^{2} y^{6} - 70 x^{2} y^{4} z^{2} + 80 x^{2} z^{6} + 5 y^{8} - 70 y^{6} z^{2} + 168 y^{4} z^{4} - 80 y^{2} z^{6}\right)}{32} $ \\
